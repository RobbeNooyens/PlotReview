...
public class GuiFactory {
	...
	public static Gui reviewGui(final ReviewStaff staff) {
		return new Gui.Builder((Player) staff.getOfflinePlayer()).fillSlots(0, 5, getReviewHeads(ReviewManager.getInstance().getReviews())).build();
	}
	...
	private static GuiItem getReviewHead(Reviewee rev, int ID) {
