...
public class UserDataFileFields {
	...
	public static enum PlayerInfoField implements UserDataField {
		AVARAGE_STOC("0"), TOTAL_STOC("0"), RATING("0"), TOTAL_PLOT_SCORE("0"), NUMBER_OF_SUBMISSIONS("0"), LATEST_NAME("unknown");
	...
	public static enum OldScoresField implements UserDataField {
		AVARAGE_STOC("0"), TOTAL_STOC("0"), RATING("0"), TOTAL_PLOT_SCORE("0");
